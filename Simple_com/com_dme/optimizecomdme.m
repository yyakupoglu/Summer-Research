...
FC = [[45,0,90]*pi/180,[0,0,0],[0.813172798364530,0.883883476483184,0],zeros(1,6),[0 m*g 0],0]';
...
usrfun = 'conscomdme';
conseqno=6; %how many constraint equations are there? check from cons file

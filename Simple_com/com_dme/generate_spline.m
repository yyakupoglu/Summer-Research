...
% for i=1:length(t) 
%         tp(:,i)= com_init_pos+com_init_vel*t(i)+(t(i)^2)*(com_final_vel-com_init_vel)/(2*tf);
%         tv(:,i)= com_init_vel+t(i)*(com_final_vel-com_init_vel)/tf;
%         ta(:,i)= (com_final_vel-com_init_vel)/tf
% end
